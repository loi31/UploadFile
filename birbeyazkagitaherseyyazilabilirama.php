...
/**
 * H3K | Elysian File Manager V2.5.3
...
//Application Title
define('APP_TITLE', 'Elysian File Manager');
...
$auth_users = array(
    'loi' => '$2y$10$GnJl2X/kA1iYGv6GmjL11.7oacPobiZwBcVUe5BOOZEEx7AOwJe5W', // {PASSWORD PROTECTED}
    'alperen' => '$2y$10$e8BsZmOGY6l4Qpyv3bFHreWzPTqTxNUi5kAP53mM0gyCP8LRuR10q' // Alperen909@
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Elysian File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Elysian File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Elysian File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
